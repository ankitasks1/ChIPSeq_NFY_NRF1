...
lists ='''
rep1 Input Input NFY NFY 160,53,50 NFY 13804282 treat
rep1 Input Input NFY NFY 0,0,0 NFY 11139369 control
rep2 Input Input NFY NFY 160,53,50 NFY 12165404 treat
...
for listx in lists:
    ...
    for sample in os.listdir('./'):
        if sample.endswith('_R1_uniq.sortedByReadname.genome.sort.JF1.rmdup.bam'):
           print 'Total number of reads in sample are: '
           os.system('samtools flagstat ' + protein + '_' + folder + '_R1_uniq.sortedByReadname.genome.sort.JF1.rmdup.bam')
           ...
           os.chdir(gse_s + '_' + folder + '_JF1_MACS_bedGraph')
           os.chdir(peakfolder)
           ...
           with open(protein + '_' + peakfolder + '_' + folder + '_R1_JF1_mm10.merge.bedgraph', 'a') as myfile:
           ...
           os.system('cp ' + protein + '_' + peakfolder + '_' + folder + '_R1_JF1_mm10.merge.bedgraph ' + protein + '_' + peakfolder + '_' + folder + '_JF1_norm.bedgraph')
           os.system('sed -i -e "1d" *_JF1_norm.bedgraph')
           os.system('sort -k1,1 -k2,2n ' + protein + '_' + peakfolder + '_' + folder + '_JF1_norm.bedgraph > ' + protein + '_' + peakfolder + '_' + folder + '_JF1_norm_sorted.bedgraph')
           os.system('~/tools_av/bedGraphToBigWig ' + protein + '_' + peakfolder + '_' + folder + '_JF1_norm_sorted.bedgraph ' + '/home/ankitv/ref_av/mm10/mm10.chrom.sizes ' + protein + '_' + peakfolder + '_' + folder + '_R1_JF1_mm10.merge.bw')
           os.system('gzip ' + protein + '_' + peakfolder + '_' + folder + '_R1_JF1_mm10.merge.bedgraph')
           os.system('cp *.bw /media/ankitv/Archivio1/2019/chip-seq/JB1_NFY_NRF1/newway/bigwigs/')
           os.system('rm -r corrected_peaks1.bdg')
           os.system('rm -r *_JF1_norm_sorted.bedgraph')
           os.system('rm -r *_JF1_norm.bedgraph')
           print 'Analysis completed for ' + protein + '_' + folder + '_JF1_' + peakfolder
           print '\n'         
