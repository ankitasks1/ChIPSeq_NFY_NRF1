...
for listx in lists:
    ...
    for sample in os.listdir('./'):
        if sample.endswith('_R1_uniq.rmdup.bam'):
           ...
           with open(protein + '_' + peakfolder + '_' + folder + '_mm10.bedgraph', 'a') as myfile:
           ...
           os.system('cp ' + protein + '_' + peakfolder + '_' + folder + '_mm10.bedgraph ' + protein + '_' + peakfolder + '_' + folder + '_norm.bedgraph')
           os.system('sed -i -e "1d" *_norm.bedgraph')
           os.system('sort -k1,1 -k2,2n ' + protein + '_' + peakfolder + '_' + folder + '_norm.bedgraph > ' + protein + '_' + peakfolder + '_' + folder + '_norm_sorted.bedgraph')
           os.system('~/tools_av/bedGraphToBigWig ' + protein + '_' + peakfolder + '_' + folder + '_norm_sorted.bedgraph ' + '/home/ankitv/ref_av/mm10/mm10.chrom.sizes ' + protein + '_' + peakfolder + '_' + folder + '_mm10.bw')
           os.system('gzip ' + protein + '_' + peakfolder + '_' + folder + '_mm10.bedgraph')
           #os.system('mv *_mm10.bedgraph.gz ./../../../../bedgraph_files')
           #os.system('mv *_mm10.bw ./../../../../bigwig_files')
           os.system('rm -r corrected_peaks1.bdg')
           os.system('rm -r *_norm_sorted.bedgraph')
           os.system('rm -r *_norm.bedgraph')
           print 'Analysis completed for ' + protein + '_' + folder + '_' + peakfolder
           print '\n'         
